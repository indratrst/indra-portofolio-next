  ...
  return (
    ...
    >
      <img
        src="/timeline-1.png"
        alt="pic hero"
        className="absolute inset-0 -z-10 -top-10 lg:-left-[170px]  -ms-[75px] lg:-ms-[500px] -mt-72 scale-[1.6] lg:-mt-96 transform lg:scale-[.7] opacity-30 dark:opacity-95"
      />
      <img
        src="/timeline-2.png"
        alt="pic hero"
        className="absolute lg:ms-[700px] inset-0 -z-10 scale-[1.6] lg:mt-12 transform lg:scale-[.4] opacity-30 dark:opacity-95"
      />
      <img
        src="/timeline-3.png"
        alt="pic hero"
        className="absolute inset-0 -z-10 -top-10 lg:-left-[250px]  -ms-[75px] lg:-ms-[500px] -mt-72 scale-[1.6] lg:mt-[500px] transform lg:scale-[.3]  rotate-12 opacity-40 dark:opacity-95"
      />
